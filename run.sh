...
# make -j8 TESTFILE=TestDupReadAtomicCache.bsv TOPMODULE=mkTestCacheFIFO 2>&1 | tee -a $RUN_LOG
...
# make -j8 TESTFILE=TestExtractAndPrependPipeOut.bsv TOPMODULE=mkTestExtractHeaderWithPayloadLessThanOneFrag 2>&1 | tee -a $RUN_LOG
...
# make -j8 TESTFILE=TestPayloadConAndGen.bsv TOPMODULE=mkTestPayloadGenSegmentAndPaddingCase 2>&1 | tee -a $RUN_LOG
...
# make -j8 TESTFILE=TestReqHandleRQ.bsv TOPMODULE=mkTestReqHandleNoAckReqCase 2>&1 | tee -a $RUN_LOG
# make -j8 TESTFILE=TestReqHandleRQ.bsv TOPMODULE=mkTestReqHandleTooManyReadAtomicReqCase 2>&1 | tee -a $RUN_LOG
...
# make -j8 TESTFILE=TestRespHandleSQ.bsv TOPMODULE=mkTestRespHandleTimeOutErrCase 2>&1 | tee -a $RUN_LOG
...
# make -j8 TESTFILE=TestRetryHandleSQ.bsv TOPMODULE=mkTestRetryHandleExcRetryLimitErrCase 2>&1 | tee -a $RUN_LOG
# make -j8 TESTFILE=TestRetryHandleSQ.bsv TOPMODULE=mkTestRetryHandleExcTimeOutLimitErrCase 2>&1 | tee -a $RUN_LOG

# make -j8 TESTFILE=TestSpecialFIFOF.bsv TOPMODULE=mkTestCacheFIFO2 2>&1 | tee -a $RUN_LOG
